...
public class GlavniProzor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resursi/bar-chart (1).png"))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ponedeljak", "Utorak", "Sreda", "Cetvrtak", "Petak", "Subota", "Nedelja" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            ps.setTime(4, Time.valueOf(jTextField3.getText()));
            ps.setTime(5, Time.valueOf(jTextField4.getText()));
            ps.execute();
            populate();
            JOptionPane.showMessageDialog(this, "Uspesan upis!","info",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void populate() throws SQLException  {
        ...
        ResultSet rs = s.executeQuery("SELECT * FROM Aktivnosti");
        DefaultTableModel dtm = new DefaultTableModel();
        dtm.addColumn("Sifra");
        dtm.addColumn("Naziv");
        dtm.addColumn("Dan");
        dtm.addColumn("Pocetak");
        dtm.addColumn("Zavrsetak");
        while(rs.next()){
            Object[] red = new Object[5];
            red[0] = rs.getInt("AktivnostID");
            red[1] = rs.getString("NazivAktivnosti");
            red[2] = rs.getString("Dan");
            red[3] = rs.getTime("Pocetak");
            red[4] = rs.getTime("Zavrsetak");
            dtm.addRow(red);
        }
